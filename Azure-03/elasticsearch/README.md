# Elasticsearch Cluster: Azure-03
...
```bash
kubectl get secret Azure-03-es-elastic-user -n Azure-03 -o jsonpath='{{.data.elastic}}' | base64 -d
```

### Port-forward Elasticsearch
```bash
kubectl port-forward svc/Azure-03-es-http -n Azure-03 9200:9200
```

### Port-forward Kibana
```bash
kubectl port-forward svc/Azure-03-kb-http -n Azure-03 5601:5601
```
