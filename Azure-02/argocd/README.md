...
|-------------|-----------|-----------|
| dev | Yes | Azure-02-dev |
| staging | Yes | Azure-02-staging |
| production | No (manual) | Azure-02-production |
...
```bash
# Sync dev
argocd app sync Azure-02-dev

# Sync all
argocd app sync Azure-02-apps
```
